...
@pytest.fixture
def simple_three_node_pipeline(simple_input_node, simple_transform_node, simple_output_node):
...
def trainable_pipeline(simple_input_node, trainable_node, simple_output_node):
    ...
    input_node = simple_input_node(batch_size=4, channels=10, height=1, width=1)
...
@pytest.fixture
def multi_branch_pipeline(simple_input_node, simple_transform_node, simple_output_node, multi_output_node):
    ...
    input_node = simple_input_node(batch_size=2, channels=10, height=1, width=1)
    multi_out = multi_output_node()
    transform_a = simple_transform_node(scale=1.5)
    transform_b = simple_transform_node(scale=0.5)
    output_a = simple_output_node()
    output_b = simple_output_node()
